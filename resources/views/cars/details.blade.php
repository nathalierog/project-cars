            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div id="carousel-example-generic" class="col-md-6 carousel" data-ride="carousel">
                                  <!-- Indicators -->
                                ...
                                @foreach ($car->images as $key => $image)
                                    ...
                                    <img src="{{url('files/car_'.$image->car_id.'_'.$image->img_number.'.'.$image->extension)}}" alt="...">  @else
                                    <div class="item">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal">Reageer</button>
                            </div>
                            <div class="col-md-6">
                                <br>
